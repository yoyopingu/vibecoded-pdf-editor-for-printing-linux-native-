...
class ManagePanel(QWidget):
    ...
    def _setup(self):
        ...
        layout.addWidget(self._listbtn(tr("Löschen"),     self._delete,          "trash",    tr("Entf")))
        layout.addWidget(self._listbtn(tr("Kopieren"),     self._copy,            "copy",     tr("Strg+C")))
        layout.addWidget(self._listbtn(tr("Einfügen"),    self._paste,           "paste",    tr("Strg+V")))
        layout.addWidget(self._listbtn(tr("Rückgängig"), self._undo,            "undo",     tr("Strg+Z")))
