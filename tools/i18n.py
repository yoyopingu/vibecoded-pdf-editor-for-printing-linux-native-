...
_EN: dict[str, str] = {
    ...
    "Kachel beschriften": "Label tiles",
    "Seiten / Bogen": "Pages / sheet",
    "Reihenfolge": "Order",
    "Horizontal": "Horizontal",
    "Horizontal umgekehrt": "Horizontal reversed",
    "Vertikal": "Vertical",
    "Vertikal umgekehrt": "Vertical reversed",
    "Seitenrahmen": "Page border",
    "Automatisch drehen": "Auto-rotate",
    "Bogen": "Sheets",
    "Bindung": "Binding",
    "Beide Seiten": "Both sides",
    "Nur Vorderseite": "Front side only",
    "Nur Rückseite": "Back side only",
    "Links": "Left",
    "Rechts": "Right",
    "Blätter": "Sheets",
    "bis": "to",
    "Kachel {p0} / {p1}": "Tile {p0} / {p1}",
    "Bogen {p0} / {p1}": "Sheet {p0} / {p1}",
    "Poster · {pct} % · Kachel {a}/{b}": "Poster · {pct} % · Tile {a}/{b}",
    ...
    "Farbseiten: {p0}": "Color pages: {p0}",
    "BERICHT -- {p0}": "REPORT -- {p0}",
    "PROBLEME ({p0}):": "ISSUES ({p0}):",
    "BESTANDEN:": "PASSED:",
    "BESTANDEN": "PASSED",
    "FEHLER ({p0} Problem(e))": "FAILED ({p0} issue(s))",
    ...
    "✓  CMYK — druckfertig.": "✓  CMYK — print-ready.",
    "Profil: {p0}  ({p1})": "Profile: {p0}  ({p1})",
    "Profil: Standard (generisch)": "Profile: Standard (generic)",
    ...
    "Seite {p0}: bereits Graustufen": "Page {p0}: already grayscale",
    "SW": "B&W",
    "Farbe": "Color",
    "Gesamt": "Total",
